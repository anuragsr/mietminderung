...
.controller('qCtrl', function($scope, $http, $timeout) {
  ...
  function uploadComplete(evt){
    ...
    answers.forEach(function(ans) {
      ...
      if(ans.q.q.indexOf("Rechtsschutzversicherung") > -1) legalExpQues = ans;      
    })

    var rentAns = parseInt(rentQues.a.text)
    , legalExpAns = legalExpQues.a.text
  ...
  // $scope.inpObj1 = { name: "Anurag Srivastava", email: "anurag.131092@gmail.com", ph: 23232323 };
